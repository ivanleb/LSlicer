...
{
    public class CrossSupportStrategy : BaseSupportStrategy, IMakeSupportStrategy
    {
        public CrossSupportStrategy(ISupportParameters parameters, int numberFrom, CancellationToken token) : base(parameters, numberFrom, token) { }
        ...
        public override IPart[] GenerateSupports(IPart part, string supportPath)
        {
            ...
            if (_parameters != null)
            {
                ...
                for (var i = 0; i < SupportPaint.Count; i++)
                {
                    ...
                    _contourGeometry.Positions.Add(new Point3D(SupportPaint[i].P1.X + WidthX * Math.Cos(Math.PI), SupportPaint[i].P1.Y + WidthX * Math.Sin(Math.PI), SupportPaint[i].P1.Z + head));
                    _contourGeometry.Positions.Add(new Point3D(SupportPaint[i].P1.X - WidthX * Math.Cos(Math.PI), SupportPaint[i].P1.Y - WidthX * Math.Sin(Math.PI), SupportPaint[i].P1.Z + head));
                    _contourGeometry.Positions.Add(new Point3D(SupportPaint[i].P2.X - WidthX * Math.Cos(Math.PI), SupportPaint[i].P2.Y - WidthX * Math.Sin(Math.PI), SupportPaint[i].P2.Z + Up - head));
                    ...
                    _contourGeometry.Positions.Add(new Point3D(SupportPaint[i].P1.X + WidthX * Math.Cos(Math.PI / 2 + Math.PI), SupportPaint[i].P1.Y + WidthX * Math.Sin(Math.PI / 2 + Math.PI), SupportPaint[i].P1.Z + head));
                    _contourGeometry.Positions.Add(new Point3D(SupportPaint[i].P1.X - WidthX * Math.Cos(Math.PI / 2 + Math.PI), SupportPaint[i].P1.Y - WidthX * Math.Sin(Math.PI / 2 + Math.PI), SupportPaint[i].P1.Z + head));
                    _contourGeometry.Positions.Add(new Point3D(SupportPaint[i].P2.X - WidthX * Math.Cos(Math.PI / 2 + Math.PI), SupportPaint[i].P2.Y - WidthX * Math.Sin(Math.PI / 2 + Math.PI), SupportPaint[i].P2.Z + Up - head));

                    _contourGeometry.Positions.Add(new Point3D(SupportPaint[i].P2.X - WidthX * Math.Cos(Math.PI / 2 + Math.PI), SupportPaint[i].P2.Y - WidthX * Math.Sin(Math.PI / 2 + Math.PI), SupportPaint[i].P2.Z + Up - head));
                    _contourGeometry.Positions.Add(new Point3D(SupportPaint[i].P2.X + WidthX * Math.Cos(Math.PI / 2 + Math.PI), SupportPaint[i].P2.Y + WidthX * Math.Sin(Math.PI / 2 + Math.PI), SupportPaint[i].P2.Z + Up - head));
                    _contourGeometry.Positions.Add(new Point3D(SupportPaint[i].P1.X + WidthX * Math.Cos(Math.PI / 2 + Math.PI), SupportPaint[i].P1.Y + WidthX * Math.Sin(Math.PI / 2 + Math.PI), SupportPaint[i].P1.Z + head));

                    _contourGeometry.Positions.Add(new Point3D(SupportPaint[i].P1.X + WidthX * Math.Cos(Math.PI + Math.PI), SupportPaint[i].P1.Y + WidthX * Math.Sin(Math.PI + Math.PI), SupportPaint[i].P1.Z + head));
                    _contourGeometry.Positions.Add(new Point3D(SupportPaint[i].P1.X - WidthX * Math.Cos(Math.PI + Math.PI), SupportPaint[i].P1.Y - WidthX * Math.Sin(Math.PI + Math.PI), SupportPaint[i].P1.Z + head));
                    _contourGeometry.Positions.Add(new Point3D(SupportPaint[i].P2.X - WidthX * Math.Cos(Math.PI + Math.PI), SupportPaint[i].P2.Y - WidthX * Math.Sin(Math.PI + Math.PI), SupportPaint[i].P2.Z + Up - head));

                    _contourGeometry.Positions.Add(new Point3D(SupportPaint[i].P2.X - WidthX * Math.Cos(Math.PI + Math.PI), SupportPaint[i].P2.Y - WidthX * Math.Sin(Math.PI + Math.PI), SupportPaint[i].P2.Z + Up - head));
                    _contourGeometry.Positions.Add(new Point3D(SupportPaint[i].P2.X + WidthX * Math.Cos(Math.PI + Math.PI), SupportPaint[i].P2.Y + WidthX * Math.Sin(Math.PI + Math.PI), SupportPaint[i].P2.Z + Up - head));
                    _contourGeometry.Positions.Add(new Point3D(SupportPaint[i].P1.X + WidthX * Math.Cos(Math.PI + Math.PI), SupportPaint[i].P1.Y + WidthX * Math.Sin(Math.PI + Math.PI), SupportPaint[i].P1.Z + head));

                    _contourGeometry.Positions.Add(new Point3D(SupportPaint[i].P1.X + WidthX * Math.Cos(Math.PI / 2 + Math.PI), SupportPaint[i].P1.Y + WidthX * Math.Sin(Math.PI / 2 + Math.PI), SupportPaint[i].P2.Z + Up - head));
                    _contourGeometry.Positions.Add(new Point3D(SupportPaint[i].P1.X - WidthX * Math.Cos(Math.PI / 2 + Math.PI), SupportPaint[i].P1.Y - WidthX * Math.Sin(Math.PI / 2 + Math.PI), SupportPaint[i].P2.Z + Up - head));
                    _contourGeometry.Positions.Add(new Point3D(SupportPaint[i].P2.X, SupportPaint[i].P2.Y, SupportPaint[i].P2.Z + Up));

                    _contourGeometry.Positions.Add(new Point3D(SupportPaint[i].P1.X + WidthX * Math.Cos(Math.PI + Math.PI), SupportPaint[i].P1.Y + WidthX * Math.Sin(Math.PI + Math.PI), SupportPaint[i].P2.Z + Up - head));
                    _contourGeometry.Positions.Add(new Point3D(SupportPaint[i].P1.X - WidthX * Math.Cos(Math.PI + Math.PI), SupportPaint[i].P1.Y - WidthX * Math.Sin(Math.PI + Math.PI), SupportPaint[i].P2.Z + Up - head));
                    _contourGeometry.Positions.Add(new Point3D(SupportPaint[i].P2.X, SupportPaint[i].P2.Y, SupportPaint[i].P2.Z + Up));
